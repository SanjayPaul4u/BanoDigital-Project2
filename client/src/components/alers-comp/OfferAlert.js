...
<div className={`fixed-top`} >
    <div id='main-offerAlert' className="alert alert-warning alert-dismissible fade show text-center" role="alert" style={IsScroll?myStyle:{}}>
